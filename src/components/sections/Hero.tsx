      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button
            ...
            className="px-6 py-3 rounded-xl bg-primary-500 text-white hover:bg-primary-600 text-lg"
          >
            About
          </button>
          <button
            onClick={() => smoothScrollTo('contact')}
            className="px-6 py-3 rounded-xl bg-white/10 text-white hover:bg-white/20 text-lg"
          >
            Contact Me
          </button>
        </div>
