    ...
    <footer className="border-t border-white/10 bg-black/30 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex justify-center space-x-6 mb-8">
          ...
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725zm-10-10.72l10 8.101 10-8.101v2.343l-10 8.101-10-8.101v-2.343z" />
            </svg>
          </a>
        </div>
